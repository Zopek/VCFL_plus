...
You can train with different scripts. Train(Baseline),Train_camcls(only include confusion loss),Train_sift(only include sift loss),Train_cen(only include center loss),Train_whole,Train_fmr(whole+fmr)
